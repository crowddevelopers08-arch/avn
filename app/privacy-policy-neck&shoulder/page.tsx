...
const PrivacyPolicyneckandshoulder: React.FC = () => {
  return (
    <>
      <Thankheader />
      <div className="bg-gradient-to-b from-gray-50 to-white max-[470px]:py-4 py-8">
        <section className="w-full max-w-4xl mx-auto px-4 py-8 max-[470px]:py-4  text-gray-800 leading-relaxed bg-white rounded-lg shadow-md">         
          {/* Title */}
          ...
          {/* Intro */}
          <div className="bg-green-50 p-6 rounded-lg mb-8 border-l-4 border-[#114520]">
            <p className="text-base md:text-lg text-gray-700">
              At{" "}
              <span className="font-semibold text-[#114520]">AVN Arogya Ayurvedic Hospital</span>,
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-[#114520] p-2 rounded-full">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-6 text-gray-800">
              <li className="flex items-center gap-2">
                <div className="w-2 h-2 bg-[#80c141] rounded-full"></div>
                Full Name
              </li>
              <li className="flex items-center gap-2">
                <div className="w-2 h-2 bg-[#80c141] rounded-full"></div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-[#014214] p-2 rounded-full">
            ...
            <ul className="space-y-3 mb-6 text-gray-800">
              ...
              <li className="flex items-start gap-2">
                ...
                Provide personalized Ayurvedic treatment recommendations and solutions.
              </li>
              <li className="flex items-start gap-2">
                <div className="w-5 h-5 bg-green-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                  <div className="w-2 h-2 bg-[#80c141] rounded-full"></div>
                </div>
                Schedule and manage your appointments at our hospital.
              </li>
              <li className="flex items-start gap-2">
                <div className="w-5 h-5 bg-green-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                  <div className="w-2 h-2 bg-[#80c141] rounded-full"></div>
                </div>
                Send important health updates or information about our Ayurvedic services (only with your consent).
              </li>
              <li className="flex items-start gap-2">
                <div className="w-5 h-5 bg-green-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                  <div className="w-2 h-2 bg-[#80c141] rounded-full"></div>
          ...
          <div className="mb-8">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6 text-gray-800">
              <li className="flex items-center gap-2 bg-green-50 p-3 rounded-md">
                <div className="w-2 h-2 bg-[#80c141] rounded-full flex-shrink-0"></div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-green-50 p-5 rounded-lg mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-semibold text-black">+91 95002 92220</span>
              </div>
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-gray-700">AVN Arogya Ayurvedic Hospital, Tamil Nadu</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700">Open Daily</span>
              </div>
            </div>
          </div>
...
export default PrivacyPolicyneckandshoulder;