...
const ThankYouPageChennai: React.FC = () => {
    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center min-h-screen px-4 py-5 bg-gradient-to-b max-[470px]:pt-[50px] pt-[100px] from-gray-900 to-black text-white text-center">
        ...
        <p className="text-base md:text-lg text-gray-300 max-w-xl mb-6">
          ...
          Meanwhile, here's what makes our Chennai clinic special:
        </p>

        {/* Chennai Clinic Highlights */}
        <div className="bg-gray-800 p-6 rounded-lg max-w-2xl mb-8 text-left">
          <h2 className="text-xl font-bold mb-4 text-[#f05623] text-center">Why Choose Our Chennai Clinic?</h2>
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span><strong>Premium Ayurvedic Care</strong> in the Heart of Chennai</span>
            </li>
            <li className="flex items-start">
              <div className="bg-[#80c141] rounded-full p-1 mr-3 mt-1">
                <div className="w-2 h-2 bg-white rounded-full"></div>
              </div>
              <span><strong>Expert Ayurvedic Doctors</strong> with Decades of Experience</span>
            </li>
            <li className="flex items-start">
              <div className="bg-[#80c141] rounded-full p-1 mr-3 mt-1">
                <div className="w-2 h-2 bg-white rounded-full"></div>
              </div>
              <span><strong>Advanced Panchakarma Therapies</strong> & Modern Facilities</span>
            </li>
            <li className="flex items-start">
              <div className="bg-[#80c141] rounded-full p-1 mr-3 mt-1">
                <div className="w-2 h-2 bg-white rounded-full"></div>
            ...
            <li className="flex items-start">
              ...
              <span><strong>Personalized Treatment Plans</strong> tailored to individual needs</span>
            </li>
            <li className="flex items-start">
              <div className="bg-[#80c141] rounded-full p-1 mr-3 mt-1">
                <div className="w-2 h-2 bg-white rounded-full"></div>
              </div>
              <span><strong>Easy Accessibility</strong> with Central Chennai Location</span>
            </li>
            <li className="flex items-start">
              <div className="bg-[#80c141] rounded-full p-1 mr-3 mt-1">
                <div className="w-2 h-2 bg-white rounded-full"></div>
              </div>
              <span><strong>4.8/5 Patient Ratings</strong> for Quality Care & Results</span>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          ...
          <Link
            href="https://www.avnarogya.in/clinics/velachery"
        ...
        <div className="flex items-center gap-2 text-gray-400 mb-2">
          ...
          <span>AVN Arogya Ayurvedic Clinic, Chennai</span>
        </div>
        ...
        <p className="mt-8 text-sm text-gray-400">
          &copy; {new Date().getFullYear()} AVN Arogya Ayurvedic Clinic, Chennai. All rights reserved.
        </p>
      </section>
...
export default ThankYouPageChennai;