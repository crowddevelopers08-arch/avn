...
/** Real knee patient journeys from the AVN Arogya channel. Add ids here to extend the wall. */
const stories: PatientStory[] = [
  {
    id: "FpzSAVHzUmI",
    patient: "Mr. Rajkumar",
    story: "Ayurvedic knee arthritis treatment success",
  },
  {
    id: "XwSxQuxXX5Y",
    patient: "Mrs. Anita",
    story: "Osteoarthritis recovery without surgery",
  },
];
...
export default function KneePainConsultationTestimonials() {
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1120px]">
        <AnimateOnScroll animation="fade-up" className="text-center">
          <KpcEyebrow tone="light">In their own words</KpcEyebrow>
          ...
          <h2 className="mx-auto mt-4 max-w-[860px] text-balance text-[25px] font-extrabold leading-[1.16] text-white sm:text-[34px] md:text-[42px]">
            ...
            <KpcAccent tone="lime">Knee Pain</KpcAccent>
          </h2>
