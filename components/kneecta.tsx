      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 max-[470px]:py-5 lg:px-8" style={{fontFamily: "'Outfit', sans-serif" }}>
        <div className="bg-[#114520] rounded-3xl p-4 sm:p-8 md:p-10 lg:p-12 text-center">
          ...
          <div className="max-w-2xl mx-auto mb-6 sm:mb-8 lg:mb-10">
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-tight mb-3 sm:mb-4 px-2">
              Get FREE Tele-Consultation
            </h2>
            <p className="text-sm sm:text-base text-[#80c141] leading-relaxed max-w-xl mx-auto px-2 sm:px-0">
              Talk to our Senior Ayurvedic Physician before you plan surgery.
 Get a customized plan from the comfort of your home.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <ul className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 text-xs sm:text-sm font-medium text-white">
              <li className="flex items-center justify-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white/5 rounded-lg">
                ...
                <span className="font-semibold text-xs sm:text-sm text-center sm:text-left">100% Free</span>
              </li>
              ...
              <li className="flex items-center justify-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white/5 rounded-lg">
                ...
                <span className="font-semibold text-xs sm:text-sm text-center sm:text-left">Available Across India</span>
              </li>
