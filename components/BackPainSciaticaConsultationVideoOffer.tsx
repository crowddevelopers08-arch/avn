...
import { BpsCta } from '@/components/BackPainSciaticaConsultationCtaButton';

/**
 * Dr. Ramesh R Varier explaining non-surgical back pain relief at AVN Arogya.
 * Swap this id to change the hero video — nothing else needs to move.
 */
const VIDEO_ID = '2KYo5c4Skp8';
const VIDEO_TITLE =
  'Back Pain Treatment in Ayurveda — Dr. Ramesh R Varier explains non-surgical relief';

/**
 * Section 2 — the guidance video, followed by the Rs 150 consultation CTA.
 */
export function BackPainSciaticaConsultationVideoOffer() {
