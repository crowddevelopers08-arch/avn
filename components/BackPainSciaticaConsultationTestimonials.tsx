...
type PatientStory = {
  ...
  patient: string;
  story: string;
  /** Optional runtime badge, e.g. "4:16" */
  duration?: string;
};

/** Real back pain & sciatica patient journeys from the AVN Arogya channel. Add ids here to extend the wall. */
const stories: PatientStory[] = [
  {
    id: "rOg8HKBmxDg",
    patient: "Ms. Vasantha",
    story: "Sciatica and back pain relief with Ayurveda",
  },
  {
    id: "wLC0LA76TLk",
    patient: "Mr. Senthil Kumar",
    story: "Ayurvedic recovery from two years of back pain",
  },
];
...
export default function BackPainSciaticaConsultationTestimonials() {
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1120px]">
        <AnimateOnScroll animation="fade-up" className="text-center">
          <BpsEyebrow tone="light">In their own words</BpsEyebrow>
          ...
          <h2 className="mx-auto mt-4 max-w-[860px] text-balance text-[25px] font-extrabold leading-[1.16] text-white sm:text-[34px] md:text-[42px]">
            ...
            <BpsAccent tone="lime">Back Pain or Sciatica</BpsAccent>
          </h2>
