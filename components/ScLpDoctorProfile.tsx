...
const doctors: LpDoctorProfile[] = [
  {
    ...
    specialization: "Treatment of Sciatica and Neurological Conditions",
    description:
      "Dr. Ramesh R Varier graduated as 1st Rank Holder from Madras University in 1986. With over 35 years of mastery in neurological and spinal conditions, he offers unmatched expertise in sciatica care and sciatic nerve pain treatment.",
    education:
      "Pioneer in non-surgical sciatica treatment, delivering lasting relief from radiating leg pain, nerve compression, and lower back stiffness through proven Ayurvedic protocols and herbal formulations.",
    achievements:
...
const ScLpDoctorProfile = () => <LpDoctorProfileSection doctors={doctors} />;

export default ScLpDoctorProfile;
