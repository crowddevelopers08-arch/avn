...
import { BackPainSciaticaConsultationVideoOffer } from '@/components/BackPainSciaticaConsultationVideoOffer';
import { BpsAccent } from '@/components/BackPainSciaticaConsultationCtaButton';

export default function BackPainSciaticaConsultationHero() {
  return (
    <section
      ...
      <div className="relative mx-auto max-w-[1280px]">
        <AnimateOnScroll animation="fade-up" className="flex flex-col items-center text-center">
          ...
          <p className="max-w-4xl text-balance text-[27px] font-extrabold leading-[1.14] text-[#1A1A1A] sm:text-[38px] md:text-[46px] lg:text-[54px]">
            Suffering From Back Pain or Sciatica?{' '}
            <BpsAccent tone="orange">Watch This Video First</BpsAccent>
          </p>

          <p className="mt-5 max-w-[720px] text-[15.5px] font-semibold leading-[1.75] text-[#2B2B2B]/85 sm:text-[17px] md:text-[18.5px]">
            We help people explore personalised non-surgical back pain and
            sciatica care options through detailed evaluation, lifestyle
            assessment, and expert guidance.
          </p>

          {/* Section 2 — the video, then the ₹150 consultation CTA */}
          <div className="mt-7 w-full sm:mt-9">
            <BackPainSciaticaConsultationVideoOffer />
          </div>
        </AnimateOnScroll>
      </div>
    </section>
