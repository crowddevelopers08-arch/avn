    ...
    <section className="bg-white px-4 py-12 max-[470px]:py-6 sm:py-12">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mb-10 max-w-4xl mx-auto space-y-5 text-gray-700 text-base sm:text-lg leading-relaxed">
          <p>
            Managing Cervical Spondylosis without resorting to surgery involves recognizing
            ...
            Cervical Spondylosis can have on your everyday life.
          </p>
          <p>
            ...
            of Cervical Spondylosis and restore your well-being.
          </p>
          <p>
            Designed with a Holistic Perspective, our treatment for Cervical Spondylosis
          ...
          <p>
            Choose a personalized and holistic path to Cervical Spondylosis relief at AVN
            Arogya.
          </p>
        </div>
        ...
        <div className="max-w-[720px] mx-auto overflow-hidden rounded-[24px] border border-[#d6e5cf] shadow-[0_18px_40px_rgba(17,69,32,0.12)]">
          <div className="relative" style={{ aspectRatio: "16/9" }}>
            <iframe
              ...
              src="https://www.youtube.com/embed/7EWt7fQbgt4"
