...
const audience = [
  {
    icon: FileSearch,
    text: "Experience persistent lower back pain or pain radiating to the legs (sciatica) and want to understand the underlying factors affecting their mobility.",
  },
  {
    icon: RefreshCcw,
    text: "Have been advised injections or spine surgery and are looking for expert guidance before making a decision.",
  },
  {
    icon: Activity,
    text: "Face difficulty while sitting, standing, walking, or performing daily activities due to back or leg pain.",
  },
  {
    icon: ClipboardList,
  ...
  {
    icon: HeartPulse,
    text: "Are looking for expert guidance to manage pain, improve mobility, and get back to daily life through a structured care plan.",
  },
];

export default function BackPainSciaticaConsultationWhoFor() {
  return (
    <section
      id="who-is-this-for"
      ...
      <div className="relative mx-auto grid max-w-[1180px] gap-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-12">
        ...
        <AnimateOnScroll animation="fade-up">
          <div className="lg:sticky lg:top-28">
            <BpsEyebrow>Is this you?</BpsEyebrow>

            <h2 className="mt-4 text-balance text-[25px] font-extrabold leading-[1.15] text-[#1A1A1A] sm:text-[34px] md:text-[40px]">
              Who Is This Back Pain or Sciatica{" "}
              <BpsAccent tone="orange">Care Program</BpsAccent> For?
            </h2>

            <p className="mt-4 max-w-[560px] text-[14px] leading-[1.8] text-[#2B2B2B]/70 sm:text-[15.5px]">
              This personalised back pain or sciatica care program is designed
              for individuals looking for deeper clarity about their condition
              through a detailed evaluation of symptoms, medical reports,
              lifestyle factors, and daily activity challenges to understand
              suitable non-surgical care options.
            </p>
