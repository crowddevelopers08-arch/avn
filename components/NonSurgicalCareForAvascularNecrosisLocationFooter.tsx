...
export default function NonSurgicalCareForAvascularNecrosisLocationFooter() {
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white px-4 py-8 sm:px-6 max-[470px]:py-4 lg:px-8" style={{ fontFamily: "'Outfit', sans-serif" }}>
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-8 flex flex-wrap justify-center gap-3 max-[470px]:mb-4">
              ...
              <button
                ...
                className={`rounded-full px-4 py-2 font-semibold transition-all duration-300 ${
                  selectedLocation === index
                    ? "scale-105 bg-[#f05623] text-white shadow-lg"
                    : "border border-gray-300 bg-white text-gray-700 hover:border-[#f05623] hover:bg-gray-50 hover:text-[#f05623]"
                }`}
              >
                {location.name}
              </button>
          ...
          <div className="grid grid-cols-1 items-center gap-8 max-[470px]:gap-4 lg:grid-cols-2 lg:gap-12">
            <div className="space-y-8" style={{ fontFamily: "'Outfit', sans-serif" }}>
              <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-lg">
                <div className="mb-6 flex items-center">
                  <div className="mr-3 h-8 w-3 rounded-full bg-[#f05623]"></div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4 rounded-lg p-3 transition-colors hover:bg-gray-50 max-[470px]:mb-0">
                    <div className="rounded-full bg-orange-100 p-2">
                      <Phone className="h-5 w-5 text-[#f05623]" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start space-x-4 rounded-lg p-3 transition-colors hover:bg-gray-50">
                    <div className="rounded-full bg-orange-100 p-2">
                      <MapPin className="h-5 w-5 text-[#f05623]" />
                    </div>
                    <div>
            ...
            <div>
              <div ref={mapContainerRef} className="relative scale-95 overflow-hidden rounded-2xl border-4 border-white opacity-0 shadow-2xl transition-all duration-700">
                <div className="animate-pulse-slow pointer-events-none absolute inset-0 rounded-xl border-[10px] border-green-500/20"></div>
                <iframe
                ...
                ></iframe>
                <div className="absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-full transform">
                ...
                <div className="absolute bottom-4 left-4 z-20 max-w-[90%] rounded-full bg-white/90 px-3 py-1.5 shadow-md">
                ...
                <button
                  ...
                  className="absolute bottom-4 right-4 z-20 flex items-center space-x-2 rounded-full bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all hover:bg-blue-700"
                >
          ...
          <div className="animate-fade-in fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4 backdrop-blur-sm">
            <div className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-2xl bg-white shadow-xl">
              <div className="sticky top-0 flex items-center justify-between border-b bg-white p-6">
                ...
                <button onClick={() => setShowDirections(false)} className="p-1 text-gray-500 transition-colors hover:text-gray-700">
                  <X className="h-5 w-5" />
                </button>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="mb-6 grid grid-cols-2 gap-4">
                    ...
                    >
                      <FaWalking className="mr-2 h-5 w-5" />
                      <span>Walking</span>
                    </button>
                  </div>
                  ...
                  <a
                    ...
                    className="flex w-full items-center justify-center rounded-xl bg-green-600 px-6 py-4 font-semibold text-white shadow-md transition-all duration-300 hover:bg-green-700"
                  >
                    <Navigation className="mr-2 h-5 w-5" />
                    Open in Google Maps
                  </a>
