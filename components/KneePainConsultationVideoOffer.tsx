...
import { KpcCta } from '@/components/KneePainConsultationCtaButton';

/**
 * Dr. Ramesh R Varier explaining knee arthritis care at AVN Arogya.
 * Swap this id to change the hero video — nothing else needs to move.
 */
const VIDEO_ID = 'bdaJcLESAaI';
const VIDEO_TITLE =
  'Knee Arthritis Ayurvedic Treatment at AVN — Dr. Ramesh R Varier explains';

/**
 * Section 2 — the guidance video, followed by the Rs 150 consultation CTA.
 */
export function KneePainConsultationVideoOffer() {
