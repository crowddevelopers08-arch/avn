...
const doctors: Doctor[] = [
  {
    ...
    education:
      "Pioneer in non-surgical joint pain treatment, delivering lasting relief from pain, stiffness, and reduced mobility through proven Ayurvedic protocols and herbal formulations.",
    achievements:
...
export default function JpLpDoctorProfile() {
    ...
    <section className="bg-[linear-gradient(180deg,#f2f7ec_0%,#eef4f8_100%)] px-4 py-10 max-[470px]:py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-10">
        ...
        >
          ...
          <div ref={carouselRef} className="flex snap-x snap-mandatory gap-6 overflow-hidden scroll-smooth">
