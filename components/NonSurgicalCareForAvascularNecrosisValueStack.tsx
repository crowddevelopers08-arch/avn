...
const lineItems = [
  { label: "1:1 AVN Specialist Consultation", price: "₹1,500" },
  { label: "MRI/X-Ray Report Review & Condition Assessment", price: "₹500" },
  { label: "AVN Stage Evaluation & Treatment Guidance", price: "₹500" },
  ...
  { label: "Diet & Wellness Guidance for Joint Health", price: "₹500" },
];

export default function NonSurgicalCareForAvascularNecrosisValueStack() {
  return (
    <section
      id="pricing"
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1040px]">
        <AnimateOnScroll animation="fade-up" className="text-center">
          <NscEyebrow tone="light">Everything included</NscEyebrow>
          <h2 className="mx-auto mt-4 max-w-[620px] text-balance text-[25px] font-extrabold leading-[1.15] text-white sm:text-[34px] md:text-[40px]">
            Start Your AVN Care <NscAccent tone="lime">Journey Today</NscAccent>
          </h2>
        </AnimateOnScroll>
            ...
            <div className="rounded-[27px] bg-[#fffaf4]">
              ...
              <div className="relative px-5 pb-1.5 pt-5 sm:px-8 sm:pt-6">
                ...
                <ul className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-10">
                  {lineItems.map((item, index) => (
                    <li
                      key={index}
                      className="flex items-start gap-2 border-b border-dashed border-[#114520]/12 py-2.5 last:border-b-0 sm:py-3 lg:[&:nth-child(n+7)]:border-b-0"
                    >
                      <Check
              ...
              <div className="px-5 pb-6 pt-5 text-center sm:px-8 sm:pb-7">
                ...
                <p className="mt-4 text-[12px] font-semibold uppercase tracking-[0.16em] text-[#2B2B2B]/50 sm:text-[13px]">
                  Start your AVN care journey today
                </p>
