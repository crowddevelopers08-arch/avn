...
const doctors: Doctor[] = [
  {
    ...
    education:
      "Pioneer in non-surgical sciatica treatment, delivering lasting relief from nerve pain, numbness, and reduced mobility through proven Ayurvedic protocols and herbal formulations.",
    achievements:
