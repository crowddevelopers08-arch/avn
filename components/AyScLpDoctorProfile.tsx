...
const doctors: Doctor[] = [
  {
    ...
    specialization: "Ayurvedic Treatment of Musculoskeletal and Neurological Conditions",
    description:
      "Dr. Ramesh R Varier graduated as 1st Rank Holder from Madras University in 1986. With over 35 years of mastery in Ayurvedic treatment of musculoskeletal and neurological conditions, he offers unmatched expertise in sciatica care through traditional Panchakarma therapies.",
    education:
      "Pioneer in Ayurvedic sciatica treatment, delivering lasting relief from nerve pain, stiffness, and restricted mobility through proven herbal protocols and classical Panchakarma formulations.",
    achievements:
  ...
  },
  {
    ...
    description:
      "Dr. Sridevi Rajeev is a highly accomplished Ayurvedic physician with exceptional expertise in treating complex musculoskeletal and rheumatological conditions. Her compassionate approach and deep Ayurvedic knowledge make her a trusted healer for sciatica patients.",
    education:
  ...
  },
  {
    ...
    specialization: "Ayurvedic Treatment of Musculoskeletal and Neurological Disorders",
    description:
      "Dr. Biju Madhavan brings extensive expertise in integrating traditional Ayurvedic wisdom with modern medical diagnostics. His holistic approach to treating sciatica and other neurological disorders has helped numerous patients regain mobility and live pain-free.",
    education:
...
export default AyScLpDoctorProfile;
