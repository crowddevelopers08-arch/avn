...
const doctors: LpDoctorProfile[] = [
  {
    ...
    education:
      "Pioneer in non-surgical sciatica treatment, delivering lasting relief from nerve pain, inflammation, and stiffness through proven Ayurvedic protocols, Panchakarma detox therapies, and herbal formulations.",
    achievements:
...
const AyScLpDoctorProfile = () => <LpDoctorProfileSection doctors={doctors} />;
