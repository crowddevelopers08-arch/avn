      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 max-[470px]:py-5 lg:px-8" style={{fontFamily: "'Outfit', sans-serif" }}>
        <div className="bg-[#114520] rounded-3xl p-4 sm:p-8 md:p-10 lg:p-12 text-center">
          ...
          <div className="max-w-2xl mx-auto mb-6 sm:mb-8 lg:mb-10">
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold tracking-tight text-white leading-tight mb-3 sm:mb-4 px-2">
             Book Your Tele-Consultation @ ₹150
            </h2>
            <p className="text-sm sm:text-base text-[#80c141] leading-relaxed max-w-xl mx-auto px-2 sm:px-0">
              Provide your basic details & pick a suitable date and time for your consultation. Speak directly with our Specialist and get a customized recovery roadmap.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto mt-8 sm:mt-10 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-white/5 rounded-xl p-4 sm:p-6">
              <div className="text-[#80c141] font-bold text-lg sm:text-xl mb-2">Identify your AVN stage</div>
              <p className="text-white text-sm">through symptoms and reports</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 sm:p-6">
              <div className="text-[#80c141] font-bold text-lg sm:text-xl mb-2">Know if non-surgical recovery</div>
              <p className="text-white text-sm">is possible</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 sm:p-6">
              <div className="text-[#80c141] font-bold text-lg sm:text-xl mb-2">Receive a personalized treatment plan</div>
