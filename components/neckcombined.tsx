...
const NecktestimonialSection = () => {
  const testimonials = [
    {
      name: "M. Arumugam",
      title: "56, Retired Headmaster",
      testimonial: "I was struggling with cervical spondylosis for years. AVN Arogya's therapy not only eased the pain but brought back my neck mobility.",
      rating: 5
    },
    {
      name: "Meenakshi V.",
      title: "43, Homemaker",
      testimonial: "My shoulder had frozen completely. Thanks to AVN, I regained 90% mobility in 5 weeks — all without injections or surgery.",
      rating: 5
    },
    {
      name: "Praveen R.",
      title: "32, Software Developer",
      testimonial: "Severe neck pain due to long screen hours had ruined my routine. The Ayurvedic treatment and posture guidance at AVN worked wonders.",
      rating: 5
    },
  ];
...
export default NecktestimonialSection;