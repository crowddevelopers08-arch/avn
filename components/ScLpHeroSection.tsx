const heroBullets = [
  "Trust our expertise of over 90+ years & 4 generations",
  "Benefit from the experience of successfully treating over 1 lakh patients",
  "Stop Suffering Endlessly from Sciatica",
  "Rediscover the Joy in your Life & Work",
  "Avail Cashless Treatment @ our NABH Certified Hospital",
];

export default function ScLpHeroSection() {
  return (
      ...
      <div className="bg-[#F0DDD3] px-4 pt-10 max-[470px]:pt-6 text-center sm:px-6 lg:hidden">
        <div className="mx-auto max-w-[520px]">
          <h1 className="mb-5 text-3xl font-black leading-tight text-gray-900 sm:text-4xl">
            Get The Best Care For Sciatica From Our Specialist Doctors
          </h1>
        </div>
      </div>
      ...
      >
        <div className="mx-auto max-w-[480px] lg:max-w-[520px]">
          ...
          <p className="mb-5 text-base leading-relaxed text-gray-700 sm:text-lg">
            Trusted sciatica specialists with extensive experience in effective ayurvedic treatment
          </p>
