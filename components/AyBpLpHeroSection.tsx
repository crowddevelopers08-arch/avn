...
export default function AyBpLpHeroSection() {
  return (
    <section id="appointment-form" className="flex flex-col lg:min-h-[580px] lg:flex-row">
      ...
      <div
        className="flex items-center px-4 py-10 text-center max-[470px]:py-6 sm:px-6 lg:px-10 lg:text-left xl:px-12"
        style={{ backgroundColor: "#F0DDD3", flex: "0 0 46%" }}
      >
        <div className="mx-auto max-w-[480px] lg:max-w-[520px]">
          <h1 className="mb-4 hidden text-3xl font-black leading-tight text-gray-900 sm:text-4xl lg:block xl:text-[2.65rem]">
            Get Complete Relief From Back Pain With Ayurveda Treatment
          </h1>
