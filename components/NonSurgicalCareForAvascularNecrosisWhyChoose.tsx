...
const insights = [
  {
    icon: Droplets,
    text: "Avascular Necrosis (AVN) occurs when blood flow to the hip bone is blocked, causing bone tissue to weaken and collapse.",
  },
  {
    icon: AlertTriangle,
    text: "It's often mistaken for back pain or arthritis — even in early stages.",
  },
  {
    icon: ShieldCheck,
    text: "If you've suffered from COVID-19, used steroids for long, or consume alcohol regularly, you may be at risk.",
  },
];
...
const protocols = [
  {
    icon: CalendarCheck,
    text: "3-Week AVN reversal protocol focused on early-stage recovery",
  },
  {
    icon: ShieldCheck,
    text: "Non-surgical solutions that prevent hip replacement",
  },
];

export default function NonSurgicalCareForAvascularNecrosisWhyChoose() {
  return (
    <section
      id="about-clinic"
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1180px]">
        <AnimateOnScroll animation="fade-up" className="text-center">
          <NscEyebrow>Why should you choose our AVN clinic?</NscEyebrow>
          ...
          <h2 className="mx-auto mt-4 max-w-[820px] text-balance text-[25px] font-extrabold leading-[1.15] text-[#1A1A1A] sm:text-[34px] md:text-[42px]">
            Treated <NscAccent tone="orange">10,000+ AVN Patients!</NscAccent> Your Journey
            Could Be Next
          </h2>
        </AnimateOnScroll>
        ...
        <div className="mt-6 grid gap-6 sm:mt-8 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)] lg:items-start lg:gap-10">
          ...
          {/* Right — what AVN is, the risk, and the protocol */}
