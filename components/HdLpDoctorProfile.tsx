...
const doctors: Doctor[] = [
  {
    ...
    specialization: "Treatment of Musculoskeletal and Disc Conditions",
    description:
    ...
    education:
      "Pioneer in non-surgical herniated disc treatment, delivering lasting relief from back pain, nerve compression, and stiffness through proven Ayurvedic protocols and herbal formulations.",
    achievements:
