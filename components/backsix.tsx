  ...
  const features = [
    {
      ...
      title: "Our rich experience of over 95 years"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Therapies suited to current day requirements"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Full range of Ayurvedic and Modern rehabilitation therapies"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Multilingual support: English, Tamil, Hindi, Malayalam"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Dedicated inpatient facility with cashless insurance tie-ups"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Led by India's leading Ayurvedic musculoskeletal expert"
    }
  ];
