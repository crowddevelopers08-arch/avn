...
const kneePainPoints = [
  ...
  "Minimizes the chances of a knee pain recurrence",
  "Patients leave with renewed confidence in life",
];

export default function KnLpAboutSection() {
      ...
      >
        <div className="text-center">
          <h2 className="mb-2 max-[470px]:mb-1 text-2xl font-bold text-[#114520] sm:mb-4 sm:text-3xl lg:text-4xl xl:text-[42px]">
            Why <span className="text-[#f05623]">AVN AROGYA</span> for Knee Pain Relief
          </h2>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            <div className="mt-4 space-y-2 sm:mt-6 sm:space-y-3 lg:mt-0">
              {kneePainPoints.map((point, index) => (
                <div
                  key={point}
