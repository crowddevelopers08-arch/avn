...
const BPS_PHONE_DISPLAY = "+91 95002 92220";
const BPS_PHONE_TEL = "+919500292220";
const BPS_WHATSAPP = "https://wa.me/919500292220";

/** Landing page this thank-you page belongs to. */
const BPS_LANDING_PAGE = "/direct-consultation-back-pain-sciatica";

/**
 * Google Ads purchase conversion for the back pain & sciatica landing page.
 *
 * TODO: paste this page's own conversion `send_to` (AW-XXXXXXXXX/label) here.
 * While it is null nothing fires.
 */
const BPS_CONVERSION_SEND_TO: string | null = null;
...
const steps = [
  ...
  },
  {
    ...
    body: "We confirm your slot, note your back pain history, and collect any scans or reports you already have.",
  },
  {
    icon: FileHeart,
    title: "Your 1:1 call with the specialist",
    body: "We review your X-ray or MRI, understand what is driving your back or leg pain, and lay out what non-surgical care would look like for you.",
  },
];

const checklist = [
  "Your most recent X-ray or MRI of the spine",
...
export default function BackPainSciaticaConsultationThankYou() {
  // Google Ads conversion — fires once, when the visitor lands here after booking.
  useEffect(() => {
    if (!BPS_CONVERSION_SEND_TO) return;
    if (typeof window !== "undefined" && window.gtag) {
      window.gtag("event", "conversion", {
        send_to: BPS_CONVERSION_SEND_TO,
        transaction_id: "",
      });
    }
  }, []);
      ...
      <section className="relative overflow-hidden px-4 pb-11 pt-10 sm:px-6 sm:pb-14 sm:pt-14 md:px-[60px]">
        ...
        <div className="relative mx-auto max-w-[820px] text-center">
          <AnimateOnScroll animation="fade-up">
            ...
            <BpsEyebrow>Your slot is booked</BpsEyebrow>
            ...
            <h1 className="mx-auto mt-4 max-w-[720px] text-balance text-[28px] font-extrabold leading-[1.18] text-[#114520] sm:text-[38px] md:text-[46px]">
              Thank you — your{" "}
              <BpsAccent tone="orange">1:1 back pain call</BpsAccent> is confirmed
            </h1>
        ...
        <div className="mx-auto max-w-[1080px]">
          <AnimateOnScroll animation="fade-up">
            <h2 className="text-center text-[22px] font-extrabold leading-[1.25] text-[#114520] sm:text-[30px] md:text-[34px]">
              What happens <BpsAccent>next</BpsAccent>
            </h2>
          </AnimateOnScroll>
