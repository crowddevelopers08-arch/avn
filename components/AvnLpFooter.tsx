...
const AvnLpFooter: React.FC = () => {
  return (
    <footer className="w-full bg-[#114520] text-[#1f2937]">
      <div className="mx-auto max-w-5xl px-4 py-10 max-[470px]:py-6 sm:px-6 lg:px-8 lg:py-12">
        <div className="flex flex-col items-center text-center">
          <Image
            ...
            width={420}
            height={108}
            className="h-auto w-[270px] object-contain sm:w-[340px] lg:w-[380px]"
          />
          <p className="mt-5 max-w-2xl text-xl font-semibold leading-snug text-white sm:text-2xl">
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-[0.88fr_0.78fr] lg:items-stretch">
          <div className="rounded-[24px] bg-white p-6 shadow-[0_18px_50px_rgba(8,28,18,0.24)] sm:p-7">
            <div className="mb-7 flex items-center gap-3">
              <span className="h-8 w-3 rounded-full bg-[#f05623]" />
              <h3 className="text-[26px] font-bold tracking-tight text-[#1e293b]">
                Madurai Hospital
              </h3>
            </div>
            ...
            <div className="space-y-7">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-[19px] font-bold text-[#1e293b]">Phone Number</h4>
                  <a
                    href="tel:+918047091234"
                    className="mt-1 block text-base font-medium text-[#475467]"
                  >
                    80470-91234
                  </a>
                  <p className="mt-1 text-base text-[#667085]">Mon-Sun, 8AM-8PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-[19px] font-bold text-[#1e293b]">Hospital Address</h4>
                  <p className="mt-2 max-w-[420px] text-base leading-[1.65] text-[#475467]">
            ...
            <a
              ...
              className="mt-8 inline-flex w-full justify-center rounded-xl bg-[#f05623] px-6 py-4 text-center text-base font-bold text-white shadow-[0_16px_30px_rgba(240,86,35,0.28)] transition-colors hover:bg-[#d94e1a] sm:w-auto sm:min-w-[340px] sm:px-8 sm:text-lg"
            >
      ...
      <div className="max-[470px]:pb-[55px]">
        <div className="w-full bg-black py-2 text-center text-sm font-medium tracking-wide text-white md:text-base">
          2026 {"©"} All Rights Reserved | AVN Arogya Ayurvedic Hospital
        </div>
      </div>

      <div className="fixed bottom-0 left-0 right-0 z-50 hidden w-full max-[470px]:flex lg:hidden">
        <div className="pointer-events-none absolute left-1/2 top-3 bottom-3 w-px -translate-x-1/2 bg-white/70" />
        <a
          href="tel:+918047091234"
          className="flex flex-1 items-center justify-center gap-2 bg-[#f05623] py-4 text-base font-bold text-white transition-all duration-300 hover:bg-[#d94e1a] active:translate-y-px"
        >
        ...
        <a
          href="/avascular-necrosis-treatment#appointment-form"
          className="flex flex-1 items-center justify-center gap-2 bg-[#f05623] py-4 text-base font-bold text-white transition-all duration-300 hover:bg-[#d94e1a] active:translate-y-px"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="white">
