...
const videos = [
  ...
  },
  {
    ...
    time: "YouTube",
    url: "https://www.youtube.com/embed/CM6gwwovDrM?start=3",
...
export default function AyBpLpYoutubePlaylist() {
  const [selectedVideo, setSelectedVideo] = useState(videos[0]);

  return (
    <section className="bg-[radial-gradient(circle_at_top,rgba(240,86,35,0.12),transparent_28%),linear-gradient(180deg,#fff3eb_0%,#fffaf6_100%)] px-4 py-10 max-[470px]:py-5 sm:px-6">
      <div className="mx-auto flex max-w-6xl flex-col items-center">
        <h2 className="mb-10 text-center text-2xl font-bold leading-tight text-[#114520] max-[470px]:mb-5 sm:text-3xl lg:text-4xl xl:text-[42px]">
          10,000+ <span className="text-[#f05623]">Patients Healed</span>
        </h2>

        <div className="flex w-full flex-col overflow-hidden rounded-[28px] border border-[#f0d7ca] bg-white/90 shadow-[0_24px_60px_rgba(240,86,35,0.12)] backdrop-blur-sm lg:h-[430px] lg:flex-row">
