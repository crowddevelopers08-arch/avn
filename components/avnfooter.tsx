...
const AvnFooter: React.FC = () => {
  ...
  <div className="flex items-stretch w-full bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)]">
    {/* Call Now Button */}
    <button 
      onClick={openLocationModal}
      className="flex-1 flex items-center justify-center gap-3 py-4 bg-[#80c141] text-white font-bold text-base transition-all duration-300 active:bg-[#6fa837] active:translate-y-px min-h-[60px]"
    >
    ...
    >
      <button 
        className="w-full flex items-center justify-center gap-3 py-4 bg-[#114520] text-white font-bold text-base transition-all duration-300 active:bg-[#0e3a1a] active:translate-y-px min-h-[60px]"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white">
