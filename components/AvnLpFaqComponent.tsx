...
const AvnLpFaqComponent: React.FC<FAQComponentProps> = ({
  faqs = [
    {
      id: 1,
      question: "What exactly is AVN?",
      answer:
        "Avascular Necrosis (AVN) is bone tissue death caused by poor blood supply, most commonly in the hip joint.",
    },
    {
      id: 2,
      question: "Can AVN be reversed without surgery?",
      answer:
        "Yes - in Stages 1 and 2, AVN can be reversed with Panchakarma + Physiotherapy.",
    },
    {
      id: 3,
      question: "How long does the treatment take?",
      answer:
        "Our integrated program lasts about 3 weeks, depending on the stage.",
    },
    {
      id: 4,
      question: "Is MRI necessary?",
      answer:
        "Yes. Early AVN is often missed on X-rays; MRI is the only accurate diagnostic tool.",
    },
    {
      id: 5,
      question: "What are the major causes of AVN?",
      answer:
        "COVID-suffered patients, long-term steroid use, alcohol consumption, smoking, and high cholesterol.",
    },
    {
      id: 6,
      question: "What happens if AVN is ignored?",
      answer:
        "It progresses to bone collapse and eventually requires hip replacement.",
    },
    {
      id: 7,
...
export default AvnLpFaqComponent;
