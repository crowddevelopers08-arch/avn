  ...
  const features = [
    {
      ...
      title: "Decades of successful outcomes in Hip AVN and joint care"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Early intervention to avoid surgical hip replacement"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Combination of Ayurvedic formulations + Panchakarma + Rehab"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Custom programs for post-viral & polyarthritis hip conditions"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Insurance tie-ups with 20+ companies for inpatient treatments"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Doctor with 35+ years of specialization in musculoskeletal care"
    }
  ];
