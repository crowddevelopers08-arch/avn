...
const arthritisPoints = [
  ...
  "Minimizes the chances of arthritis recurrence",
  "Patients leave with renewed confidence in life",
];

export default function ArthritisTreatmentWithoutSurgeryAboutSection() {
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            <div className="mt-4 space-y-2 sm:mt-6 sm:space-y-3 lg:mt-0">
              {arthritisPoints.map((point, index) => (
                <div
                  key={point}
