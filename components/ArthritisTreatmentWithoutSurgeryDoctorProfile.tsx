...
const ArthritisTreatmentWithoutSurgeryDoctorProfile = () => {
        ...
        >
          ...
          >
            {carouselImages.map((image, index) => (
              ...
              >
                <div className="relative h-56 overflow-hidden bg-[#f4f4f4] sm:h-auto sm:aspect-[0.93/1]">
                  <Image
                    src={image}
...
export default ArthritisTreatmentWithoutSurgeryDoctorProfile;
