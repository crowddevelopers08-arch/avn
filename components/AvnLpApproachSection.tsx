export default function AvnLpApproachSection() {
  return (
    <section className="bg-[linear-gradient(180deg,#eef6e7_0%,#f8fcf5_100%)] px-4 py-12 max-[470px]:py-6 sm:py-12">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h3 className="text-lg sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 max-w-3xl mx-auto leading-snug">
          90+ Years of Proprietary Treatment Protocols for AVN Treatment
        </h3>

        <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-10 max-w-3xl mx-auto">
          Our Holistic Treatment for Avascular Necrosis is designed to address the root
          cause of the condition while providing comprehensive relief. Our approach focuses
          on arresting the progress of the disease, alleviating pain, and enhancing your
          overall health.
        </p>
        ...
        <div className="max-w-[720px] mx-auto overflow-hidden rounded-[24px] border border-[#d6e5cf] shadow-[0_18px_40px_rgba(17,69,32,0.12)]">
          <div className="relative" style={{ aspectRatio: "16/9" }}>
            <iframe
              ...
              title="Dr. Ramesh R Varier explains about Avascular Necrosis"
              frameBorder="0"
