  ...
  const features = [
    {
      ...
      title: "95+ years of Ayurvedic expertise in musculoskeletal care"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Tailored Therapies for Modern Lifestyle & Postural Issues"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Full Range of Ayurvedic + Modern Rehab Therapies"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
    ...
    },
    {
      ...
      title: "Inpatient Facilities with Cashless Insurance Tie-ups"
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
      ...
      title: "Led by India's Top Ayurvedic Specialists for Neck, Shoulder & Spine"
    }
  ];
