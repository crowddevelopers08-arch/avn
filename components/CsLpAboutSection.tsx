...
export default function CsLpAboutSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`bg-white px-4 py-6 max-[470px]:py-4 transition-all duration-1000 sm:px-6 sm:py-8 lg:px-8 lg:py-8 ${
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            <div className="mt-4 space-y-2 sm:mt-6 sm:space-y-3 lg:mt-0">
              {cervicalPoints.map((point, index) => (
                <div
                  key={point}
