...
const KneeTestimonialSection = () => {
  const testimonials = [
    {
      name: "R. Kannan",
      title: "65, Retired Bank Officer",
      testimonial: "I was advised knee replacement 2 years ago. AVN Arogya's Ayurvedic protocol helped me walk without pain — surgery postponed indefinitely.",
      rating: 5
    },
    {
      name: "Sujatha B.",
      title: "48, Boutique Owner",
      testimonial: "Post-viral arthritis made it difficult to stand for even 10 minutes. I took AVN Arogya treatment and now manage my daily tasks independently.",
      rating: 5
    },
    {
      name: "Ramesh Jain",
      title: "35, Marathon Enthusiast",
      testimonial: "Years of running caused knee and ankle pain. AVN gave me structured rehab with Ayurvedic care — it worked like magic.",
      rating: 5
    },
  ];
...
export default KneeTestimonialSection;