...
export function AvnconsultationModal({ isOpen, onClose }: ConsultationModalProps) {
    ...
    if (isOpen && selectedLocation) {
      const loadZohoForm = () => {
        ...
        const formConfigs = {
          ...
          madurai: {
            divId: "zf_div_JGBllQ6BA9Lv2sgqpyHzlQk-jP2QosiIElHLogwdEJQ",
            formPerma: "JGBllQ6BA9Lv2sgqpyHzlQk-jP2QosiIElHLogwdEJQ",
            ariaLabel: "Avn-treatments",
            height: "1013px"
          }
        }
        ...
        script.innerHTML = `
          (function() {
            try{
              ...
              var ifrmSrc = 'https://forms.zohopublic.in/org60008244182/form/${selectedLocation === 'madurai' ? 'Avntreatments' : selectedLocation.charAt(0).toUpperCase() + selectedLocation.slice(1)}/formperma/${config.formPerma}?zf_rszfm=1';
          ...
          >
              ...
              <div className="h-full flex flex-col items-center justify-center py-4 sm:py-6">
                <div className="text-center max-w-md mx-auto w-full">
                  ...
                  <p className="text-sm text-gray-600 mb-8">
                    Select your nearest clinic location to book a consultation with our AVN specialists.
                  </p>
            ...
            {selectedLocation && (
              <div className="h-full flex flex-col">
                ...
                {/* Madurai Form */}
                <div 
                  id="zf_div_JGBllQ6BA9Lv2sgqpyHzlQk-jP2QosiIElHLogwdEJQ"
