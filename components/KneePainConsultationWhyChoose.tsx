...
const insights = [
  {
    icon: Stethoscope,
    text: "Knee pain can develop due to multiple factors including age-related changes, injuries, lifestyle patterns, weight-related stress, and joint health concerns.",
  },
  {
    icon: AlertTriangle,
    text: "Many people ignore early knee pain symptoms until they start affecting their daily activities.",
  },
  {
    icon: Footprints,
    text: "If you experience knee stiffness, difficulty walking, discomfort while climbing stairs, or reduced mobility, early evaluation can help you understand your condition better.",
  },
];
...
const protocols = [
  {
    icon: ClipboardCheck,
    text: "Personalised knee pain evaluation based on symptoms and lifestyle factors",
  },
  {
    icon: ShieldCheck,
...
export default function KneePainConsultationWhyChoose() {
  return (
    <section
      id="about-clinic"
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1180px]">
        <AnimateOnScroll animation="fade-up" className="text-center">
          <KpcEyebrow>Why should you choose our knee pain clinic?</KpcEyebrow>
          ...
          <h2 className="mx-auto mt-4 max-w-[820px] text-balance text-[25px] font-extrabold leading-[1.15] text-[#1A1A1A] sm:text-[34px] md:text-[42px]">
            Treated <KpcAccent tone="orange">10,000+ Joint Pain Patients!</KpcAccent> Your
        ...
        <div className="mt-6 grid gap-6 sm:mt-8 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)] lg:items-start lg:gap-10">
          ...
          {/* Right — what drives knee pain, why early matters, and the approach */}
