...
import { KneePainConsultationVideoOffer } from '@/components/KneePainConsultationVideoOffer';
import { KpcAccent } from '@/components/KneePainConsultationCtaButton';

export default function KneePainConsultationHero() {
  return (
    <section
      ...
      <div className="relative mx-auto max-w-[1280px]">
        <AnimateOnScroll animation="fade-up" className="flex flex-col items-center text-center">
          ...
          <h1 className="nsc-sweep relative mb-5 max-w-full overflow-hidden rounded-[22px] border border-[#f05623]/40 bg-white/70 px-4 py-2.5 text-[9.5px] font-semibold uppercase leading-[1.75] tracking-[0.12em] text-[#114520] shadow-[0_6px_20px_rgba(240,86,35,0.18)] backdrop-blur-sm sm:rounded-full sm:px-7 sm:text-[10.5px] sm:tracking-[0.14em] lg:whitespace-nowrap lg:text-[11.5px]">
            ...
            Personalised Non-Surgical Care for Knee Pain, Helping Patients
            Across India
          </h1>
          ...
          <p className="max-w-4xl text-balance text-[27px] font-extrabold leading-[1.14] text-[#1A1A1A] sm:text-[38px] md:text-[46px] lg:text-[54px]">
            Before You Ignore Your Knee Pain,{' '}
            <KpcAccent tone="orange">Watch This Video First</KpcAccent>
          </p>

          <p className="mt-5 max-w-[720px] text-[15.5px] font-semibold leading-[1.75] text-[#2B2B2B]/85 sm:text-[17px] md:text-[18.5px]">
            We help people explore personalised non-surgical knee pain care
            options through detailed evaluation, lifestyle assessment, and
            expert guidance.
          </p>

          {/* Section 2 — the video, then the ₹150 consultation CTA */}
          <div className="mt-7 w-full sm:mt-9">
            <KneePainConsultationVideoOffer />
          </div>
        </AnimateOnScroll>
      </div>
    </section>
