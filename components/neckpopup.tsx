    ...
    if (isOpen && selectedLocation) {
      const loadZohoForm = () => {
        ...
        const formConfigs = {
          ...
          madurai: {
            divId: "zf_div_rqqIpba7-bhvuSsUWy1RUJpyjaUZ3IoyW_fXMNGBX-w",
            formPerma: "rqqIpba7-bhvuSsUWy1RUJpyjaUZ3IoyW_fXMNGBX-w",
            ariaLabel: "Neck and shoulder",
            height: "1034px",
            formName: "Neckandshoulder"
          }
        }
          ...
          >
              ...
              <div className="h-full flex flex-col items-center justify-center py-4 sm:py-6">
                <div className="text-center max-w-md mx-auto w-full">
                  ...
                  <p className="text-sm text-gray-600 mb-8">
                    Select your nearest clinic location to book a consultation with our neck and shoulder pain specialists.
                  </p>
            ...
            {selectedLocation && (
              <div className="h-full flex flex-col">
                ...
                {/* Madurai Form (Neck and Shoulder Treatment) */}
                <div 
                  id="zf_div_rqqIpba7-bhvuSsUWy1RUJpyjaUZ3IoyW_fXMNGBX-w"
