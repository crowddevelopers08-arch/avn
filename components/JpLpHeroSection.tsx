...
export default function JpLpHeroSection() {
  return (
    <section id="appointment-form" className="flex flex-col lg:min-h-[580px] lg:flex-row">
      ...
      <div
        className="flex items-center px-4 py-10 text-center sm:px-6 max-[470px]:py-6 lg:px-10 lg:text-left xl:px-12"
