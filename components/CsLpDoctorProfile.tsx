...
const doctors: LpDoctorProfile[] = [
  {
    ...
    education:
      "Pioneer in non-surgical cervical spondylosis treatment, delivering lasting relief from neck pain, stiffness, and nerve compression through proven Ayurvedic protocols and herbal formulations.",
    achievements:
...
const CsLpDoctorProfile = () => <LpDoctorProfileSection doctors={doctors} />;
