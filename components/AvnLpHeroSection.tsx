export default function AvnLpHeroSection() {
  return (
      ...
      <div className="bg-[#F0DDD3] px-4 pt-10 max-[470px]:pt-6 text-center sm:px-6 lg:hidden">
        <div className="mx-auto max-w-[520px]">
          <h1 className="mb-5 text-3xl font-black leading-tight text-gray-900 sm:text-4xl">
            Proven Non-Surgical AVN Treatment with High Success Rate
          </h1>
        </div>
      </div>
      ...
      >
        <div className="mx-auto max-w-[480px] lg:max-w-[520px]">
          ...
          <p className="text-base leading-relaxed text-gray-700 sm:text-lg">
            1,500+ AVN Patients with grades 1-4 have shown significant
            improvement in their conditions and are now leading normal lives
            after undergoing our Holistic Ayurvedic Treatment for Avascular
            Necrosis. All our patients embark on a transformative experience,
            where we bring nature and science together in healing.
          </p>
        </div>
      </div>
    </section>
