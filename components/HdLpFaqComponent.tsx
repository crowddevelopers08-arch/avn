...
const HdLpFaqComponent: React.FC<FAQComponentProps> = ({
  faqs = [
    {
      id: 1,
      question: "What is a Herniated Disc?",
      answer:
        "A herniated disc happens when the soft inner portion of a spinal disc pushes outward and irritates nearby nerves. In Ayurveda, it is often linked to Vata imbalance causing pain, stiffness, and radiating symptoms.",
    },
    {
      id: 2,
      question: "Can it be treated without surgery?",
      answer:
        "Yes. Holistic Ayurvedic treatments focus on reducing inflammation, relieving nerve irritation, relaxing muscles, and supporting spinal stability.",
    },
    {
      id: 3,
      question: "How long does treatment take?",
      answer:
        "Mild: Improves with medicines and exercises\nModerate to severe: 10-21 days in-patient care\nRecovery: Noticeable relief in 45 days; major recovery in 2-4 months",
    },
    {
      id: 4,
      question: "Is MRI required?",
      answer:
        "Yes. It helps assess the disc condition, nerve involvement, and guides the right treatment plan.",
    },
    {
      id: 5,
      question: "What are the main causes?",
      answer:
        "Common causes include poor posture, disc degeneration, sudden strain, improper lifting, obesity, and long hours of sitting.",
    },
    {
      id: 6,
      question: "What if untreated?",
      answer:
        "It may lead to persistent pain, numbness, weakness, and in severe cases nerve compression that affects movement and daily activities.",
    },
    {
      id: 7,
...
export default HdLpFaqComponent;
