...
const backPainPoints = [
  ...
  "Minimizes the chances of a Back Pain recurrence",
  "Patients leave with renewed confidence in life",
];

export default function AyBpLpAboutSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`bg-white px-4 py-8 transition-all duration-1000 max-[470px]:py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-8 ${
      ...
      >
        <div className="text-center">
          <h2 className="mb-4 text-2xl font-bold text-[#114520] max-[470px]:mb-0 sm:text-3xl lg:text-4xl xl:text-[42px]">
            Why <span className="text-[#f05623]">AVN AROGYA</span> for Back Pain Relief
          </h2>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            <div className="mt-4 space-y-2 sm:mt-6 sm:space-y-3 lg:mt-0">
              {backPainPoints.map((point, index) => (
                <div
                  key={point}
