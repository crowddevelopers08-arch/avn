...
const jointPainPoints = [
  "Ayurvedic Treatment at AVN Arogya avoids surgery and enhances your quality of life.",
  "Over 90+ years of experience make us the best in providing effective healing services.",
  "Time-tested, safe, and effective treatment",
  "Natural and holistic approach to healing",
  "Minimizes the chances of Joint Pain recurrence",
  "Patients leave with renewed confidence in life",
];

export default function JpLpAboutSection() {
    ...
    >
      ...
      >
        <div className="text-center">
          <h2 className="mb-2 text-2xl font-bold text-[#114520] max-[470px]:mb-1 sm:mb-4 sm:text-3xl lg:text-4xl xl:text-[42px]">
            Why <span className="text-[#f05623]">AVN AROGYA</span> for Joint Pain Relief
          </h2>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            <div className="mt-4 space-y-2 sm:mt-6 sm:space-y-3 lg:mt-0">
              {jointPainPoints.map((point, index) => (
                <div
                  key={point}
          ...
          <div aria-hidden="true" className="order-1 relative mt-6 lg:order-2 lg:mt-0">
            ...
            <div
              ...
              className={`absolute -right-3 -top-3 z-0 h-16 w-16 rounded-full bg-[#f05623] shadow-lg transition-all duration-1000 sm:-right-4 sm:-top-4 sm:h-20 sm:w-20 lg:-right-6 lg:-top-6 lg:h-24 lg:w-24 ${
                isVisible ? "rotate-0 scale-100 opacity-90" : "-rotate-45 scale-0 opacity-0"
              }`}
            ...
            <div
              ...
              className={`absolute -bottom-4 -left-4 z-0 h-20 w-20 rounded-2xl bg-[#80c141] shadow-lg transition-all duration-1000 sm:-bottom-5 sm:-left-5 sm:h-24 sm:w-24 lg:-bottom-8 lg:-left-8 lg:h-32 lg:w-32 ${
                isVisible ? "rotate-0 scale-100 opacity-80" : "rotate-45 scale-0 opacity-0"
              }`}
