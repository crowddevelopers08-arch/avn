...
export function HipconsultationModal({ isOpen, onClose }: ConsultationModalProps) {
    ...
    if (isOpen && selectedLocation) {
      const loadZohoForm = () => {
        ...
        const formConfigs = {
          ...
          madurai: {
            divId: "zf_div_UoQ315YAFQQyof_NV3LsQVwbwNVG1A7nDMq3ORrOITs",
            formPerma: "UoQ315YAFQQyof_NV3LsQVwbwNVG1A7nDMq3ORrOITs",
            ariaLabel: "Hip-treatments",
            height: "1034px",
            formName: "Hiptreatments"
          }
        }
          ...
          >
              ...
              <div className="h-full flex flex-col items-center justify-center py-4 sm:py-6">
                <div className="text-center max-w-md mx-auto w-full">
                  ...
                  <p className="text-sm text-gray-600 mb-8">
                    Select your nearest clinic location to book a consultation with our hip pain specialists.
                  </p>
            ...
            {selectedLocation && (
              <div className="h-full flex flex-col">
                ...
                {/* Madurai Form (Hip Treatment) */}
                <div 
                  id="zf_div_UoQ315YAFQQyof_NV3LsQVwbwNVG1A7nDMq3ORrOITs"
